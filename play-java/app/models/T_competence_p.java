...
public class T_competence_p extends Model {
    ...
    public T_competence_p(String CP_name, int CP_parent_id, String CP_description, int CP_coeff) {
    ...
    public static T_competence_p create(String CP_name, int CP_parent_id, String CP_description, int CP_coeff) {
        T_competence_p t_competence_p = new T_competence_p(CP_name, CP_parent_id, CP_description, CP_coeff);
        t_competence_p.save();
