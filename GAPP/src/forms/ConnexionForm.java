...
public final class ConnexionForm {
    ...
    private void traiterLoginAndPassword(String login, String password,  T_member_p t_member_p) {
        try {
        	validationLoginAndPassword(login, password, t_member_p);
    ...
    private void validationLoginAndPassword(String login, String password, T_member_p t_member_p) throws FormValidationException {
        if (login != null && password != null) {
            if (t_member_pDao.trouverLoginAndPassword(login, password) == null) {
            	System.out.println("Le login ou le mot de passe est invalide");
                throw new FormValidationException( "Le login ou le mot de passe est invalide" );
            }
        } else {
        	System.out.println("Merci de saisir un login et un mot de passe.");
            throw new FormValidationException( "Merci de saisir un login et un mot de passe." );
        }
    }
    /*
